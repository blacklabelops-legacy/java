...
pushImage ubuntu.jdk8 $PUSH_REPOSITORY
pushImage ubuntu.jdk8.$ORACLE_8_JAVA_UPDATE_VERSION.$ORACLE_8_JAVA_BUILD_NUMBER $PUSH_REPOSITORY
...
pushImage ubuntu.jre8 $PUSH_REPOSITORY
pushImage ubuntu.jre8.$ORACLE_8_JAVA_UPDATE_VERSION.$ORACLE_8_JAVA_BUILD_NUMBER $PUSH_REPOSITORY
...
pushImage ubuntu.jdk7 $PUSH_REPOSITORY
pushImage ubuntu.jdk7.$ORACLE_7_JAVA_UPDATE_VERSION.$ORACLE_7_JAVA_BUILD_NUMBER $PUSH_REPOSITORY
...
pushImage ubuntu.jre7 $PUSH_REPOSITORY
pushImage ubuntu.jre7.$ORACLE_7_JAVA_UPDATE_VERSION.$ORACLE_7_JAVA_BUILD_NUMBER $PUSH_REPOSITORY
