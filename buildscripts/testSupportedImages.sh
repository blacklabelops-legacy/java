...
source $CUR_DIR/testImage.sh ubuntu.jdk8 jdk true
source $CUR_DIR/testImage.sh ubuntu.jdk8.$ORACLE_8_JAVA_UPDATE_VERSION.$ORACLE_8_JAVA_BUILD_NUMBER jdk true
...
source $CUR_DIR/testImage.sh ubuntu.jre8 jre true
source $CUR_DIR/testImage.sh ubuntu.jre8.$ORACLE_8_JAVA_UPDATE_VERSION.$ORACLE_8_JAVA_BUILD_NUMBER jre true
...
source $CUR_DIR/testImage.sh ubuntu.jdk7 jdk true
source $CUR_DIR/testImage.sh ubuntu.jdk7.$ORACLE_7_JAVA_UPDATE_VERSION.$ORACLE_7_JAVA_BUILD_NUMBER jdk true
...
source $CUR_DIR/testImage.sh ubuntu.jre7 jre true
source $CUR_DIR/testImage.sh ubuntu.jre7.$ORACLE_7_JAVA_UPDATE_VERSION.$ORACLE_7_JAVA_BUILD_NUMBER jre true
